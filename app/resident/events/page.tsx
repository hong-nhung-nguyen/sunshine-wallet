      ...
      {resident.nextEvent ? (
        <Card className="mt-7 border-amber-300">
          ...
          {resident.resource ? (
            ...
            <div className="mt-5 rounded-2xl bg-emerald-50 p-4 text-sm text-emerald-900">
              <b>Eligibility confirmed.</b> This event contributes to the
              monthly Equity Dividend after verification.
            </div>
          )}
        </Card>
      ) : (
        <Card className="mt-7 border-amber-300">
          ...
          <h2 className="mt-2 text-xl font-semibold">
            {contributor
              ? "Register a resource to receive requests"
              : "Eligibility review comes first"}
          </h2>
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            {contributor
              ? "Once Council approves an eligible resource, suitable flexibility requests will appear here."
              : "After Council confirms your eligibility, community events that contribute to your monthly Equity Dividend will appear here."}
          </p>
        </Card>
      )}
      {!resident.isNew ? (
        <Card className="mt-4">
          ...
          <p className="mt-4 text-sm leading-6 text-[var(--muted)]">
            The community shifted 14.7 kWh. The result passed Council
            verification and your{" "}
            {contributor ? "Contributor Reward" : "Equity Dividend"} was posted.
          </p>
        </Card>
      ) : null}
    </div>
